<?php
// search.php — Reservations: Search by Name (POST)
...
<head>
    ...
    <title>DineBook — Search Reservation</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Reservations</a></li><li class="breadcrumb-item active">Search by Name</li></ol></nav>
        <h2 class="page-header">Search Reservation by Name</h2>
