<?php
// search_v3.php — Reservations: Search by GET (link-based)
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Reservations</a></li><li class="breadcrumb-item active">Search by Link</li></ol></nav>
        <h2 class="page-header">Search Reservation by Link</h2>
        <p>Click on a guest name to search for their reservation:</p>
        <ul class="list-group">
            <li class="list-group-item"><a href="search_process3.php?guest_name=John">John</a></li>
            <li class="list-group-item"><a href="search_process3.php?guest_name=Maria">Maria</a></li>
            <li class="list-group-item"><a href="search_process3.php?guest_name=Carlos">Carlos</a></li>
            <li class="list-group-item"><a href="search_process3.php?guest_name=Ana">Ana</a></li>
            <li class="list-group-item"><a href="search_process3.php?guest_name=Pedro">Pedro</a></li>
        </ul>
