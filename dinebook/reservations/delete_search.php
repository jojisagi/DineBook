<?php
// delete_search.php — Reservations: Show record + confirm delete
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Reservations</a></li><li class="breadcrumb-item active">Confirm Delete</li></ol></nav>
        ...
        <?php elseif ($record): ?>
            <p>The following reservation was found. Confirm deletion:</p>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr><td>Time</td><td><?php echo htmlspecialchars($record['arrival_time']); ?></td></tr>
