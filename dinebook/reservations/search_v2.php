<?php
// search_v2.php — Reservations: Search by Selectable Field
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Reservations</a></li><li class="breadcrumb-item active">Search by Field</li></ol></nav>
        <h2 class="page-header">Search Reservation by Field</h2>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="search_field" name="search_field" required>
                            ...
                            <option value="zone">Seating Zone</option>
