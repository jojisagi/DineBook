<?php
// search_process.php — Reservations: Search result (POST)
    ...
    <div class="container mt-4">
        ...
        <?php elseif ($record): ?>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr><td>Guest Type</td><td><span class="badge badge-tier-<?php echo htmlspecialchars($record['guest_type'] ?? 'new'); ?>"><?php echo htmlspecialchars($record['guest_type'] ?? 'new'); ?></span></td></tr>
