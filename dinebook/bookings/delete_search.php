<?php
// delete_search.php — Bookings: Show record + confirm delete
require_once __DIR__ . '/../auth/guard.php';
require_once __DIR__ . '/../config.php';

if ($_SERVER['REQUEST_METHOD'] !== 'POST' || empty($_POST['assigned_by'])) { header('Location: delete.php'); exit; }
$val = $_POST['assigned_by'];
try { $record = $bookings->findOne(['assigned_by' => $val]); } catch (Exception $e) { $record = null; $dbError = $e->getMessage(); }
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>DineBook — Confirm Delete Booking</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="/dinebook/css/style.css"></head>
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Bookings</a></li><li class="breadcrumb-item active">Confirm Delete</li></ol></nav>
        ...
        <div class="table-responsive"><table class="table table-striped table-hover table-bordered">
            ...
            <tr><td>Status</td><td><?php echo htmlspecialchars($record['booking_status']??'pending'); ?></td></tr>
            <tr><td>Payment</td><td><?php echo htmlspecialchars($record['payment_status']??'unpaid'); ?></td></tr>
