<?php
// modify.php — Bookings: Modify search form
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="card"><div class="card-body form-section">
            <form method="post" action="modify_search.php">
                <div class="mb-3"><label for="assigned_by" class="form-label">Assigned By (Hostess Name)</label><input type="text" class="form-control" id="assigned_by" name="assigned_by" required></div>
                <button type="submit" class="btn btn-primary">Search to Modify</button>
            </form>
        </div></div>
