<?php
// search_process2.php — Tables: Search by selectable field
...
$filter = [];
switch ($field) {
    case 'table_number': $filter = ['table_number' => (int)$value]; break;
    case 'zone':         $filter = ['zone' => $value]; break;
    case 'shape':        $filter = ['shape' => $value]; break;
    case 'status':       $filter = ['status' => $value]; break;
    case 'floor':        $filter = ['floor' => (int)$value]; break;
    default:             $filter = ['table_number' => (int)$value]; break;
}
try {
    $cursor = $tables->find($filter);
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Tables</a></li><li class="breadcrumb-item active">Search Results</li></ol></nav>
        ...
        <?php else: ?>
            <p><?php echo count($records); ?> table(s) found.</p>
            <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered">
                <thead><tr><th>Table #</th><th>Label</th><th>Capacity</th><th>Floor</th><th>Zone</th><th>Shape</th><th>Status</th><th>Power</th><th>Accessible</th><th>Notes</th></tr></thead>
                <tbody>
