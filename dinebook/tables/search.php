<?php
// search.php — Tables: Search by Table Number (POST)
...
<head>
    ...
    <title>DineBook — Search Table</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Tables</a></li><li class="breadcrumb-item active">Search by Table Number</li></ol></nav>
        <h2 class="page-header">Search Table by Table Number</h2>
