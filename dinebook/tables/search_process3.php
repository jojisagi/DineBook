<?php
// search_process3.php — Tables: Search by GET parameter
require_once __DIR__ . '/../auth/guard.php';
require_once __DIR__ . '/../config.php';

if (!isset($_GET['table_number']) || $_GET['table_number'] === '') {
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Tables</a></li><li class="breadcrumb-item active">Search Results (GET)</li></ol></nav>
