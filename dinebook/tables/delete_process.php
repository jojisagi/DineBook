<?php
// delete_process.php — Tables: Execute delete
...
try {
    ...
    $result = $tables->deleteOne(['_id' => $oid]);
...
<head>
    ...
    <title>DineBook — Table Deleted</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Tables</a></li><li class="breadcrumb-item active">Deleted</li></ol></nav>
        <h2 class="page-header">Delete Table</h2>
        <?php if (isset($dbError)): ?>
            <div class="alert alert-danger">Database error: <?php echo htmlspecialchars($dbError); ?></div>
        <?php elseif ($deleted): ?>
            <div class="alert alert-success success-msg">The table has been successfully deleted.</div>
        <?php else: ?>
            <div class="alert alert-danger">The table could not be found or was already deleted.</div>
        <?php endif; ?>
