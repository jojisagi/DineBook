<?php
// delete.php — Tables: Delete search form
...
<head>
    ...
    <title>DineBook — Delete Table</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Tables</a></li><li class="breadcrumb-item active">Delete</li></ol></nav>
        <h2 class="page-header">Delete Table</h2>
        <div class="card"><div class="card-body form-section">
            <p>Search for the table you want to delete:</p>
