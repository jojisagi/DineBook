<?php
// delete_process.php — Guests: Execute delete
...
try {
    ...
    $result = $guests->deleteOne(['_id' => $oid]);
...
<head>
    ...
    <title>DineBook — Guest Deleted</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Guests</a></li><li class="breadcrumb-item active">Deleted</li></ol></nav>
        <h2 class="page-header">Delete Guest</h2>
        <?php if (isset($dbError)): ?>
            <div class="alert alert-danger">Database error: <?php echo htmlspecialchars($dbError); ?></div>
        <?php elseif ($deleted): ?>
            <div class="alert alert-success success-msg">The guest has been successfully deleted.</div>
        <?php else: ?>
            <div class="alert alert-danger">The guest could not be found or was already deleted.</div>
        <?php endif; ?>
