<?php
// search_process.php — Guests: Search result (POST)
    ...
    <div class="container mt-4">
        ...
        <?php elseif ($record): ?>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                ?></td></tr>
                <tr><td>Loyalty Tier</td><td><span class="badge badge-tier-<?php echo htmlspecialchars($record['loyalty_tier'] ?? 'standard'); ?>"><?php echo htmlspecialchars($record['loyalty_tier'] ?? 'standard'); ?></span></td></tr>
