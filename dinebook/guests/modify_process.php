<?php
// modify_process.php — Guests: Execute update
...
try {
    ...
    $result = $guests->updateOne(['_id' => $oid], ['$set' => $updateData]);
...
<head>
    ...
    <title>DineBook — Guest Updated</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Guests</a></li><li class="breadcrumb-item active">Updated</li></ol></nav>
        ...
        <?php elseif ($updated): ?>
            <div class="alert alert-success success-msg">Guest <strong><?php echo htmlspecialchars($updateData['full_name']); ?></strong> updated successfully.</div>
        <?php else: ?>
            <div class="alert alert-danger">The guest could not be updated.</div>
        <?php endif; ?>
