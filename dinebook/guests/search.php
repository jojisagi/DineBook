<?php
// search.php — Guests: Search by Name (POST)
...
<head>
    ...
    <title>DineBook — Search Guest</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Guests</a></li><li class="breadcrumb-item active">Search by Name</li></ol></nav>
        <h2 class="page-header">Search Guest by Name</h2>
