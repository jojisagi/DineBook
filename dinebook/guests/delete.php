<?php
// delete.php — Guests: Delete search form
...
<head>
    ...
    <title>DineBook — Delete Guest</title>
...
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">Guests</a></li><li class="breadcrumb-item active">Delete</li></ol></nav>
        <h2 class="page-header">Delete Guest</h2>
        <div class="card"><div class="card-body form-section">
            <p>Search for the guest you want to delete:</p>
