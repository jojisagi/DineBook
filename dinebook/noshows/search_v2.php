<?php
// search_v2.php — No-Shows: Search by selectable field
require_once __DIR__ . '/../auth/guard.php';
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>DineBook — Search No-Show by Field</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="/dinebook/css/style.css"></head>
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">No-Shows</a></li><li class="breadcrumb-item active">Search by Field</li></ol></nav>
        <h2 class="page-header">Search No-Show by Field</h2>
        <div class="card"><div class="card-body form-section">
            <form method="post" action="search_process2.php">
                <div class="row"><div class="col-md-6 mb-3"><label for="search_field" class="form-label">Search By</label><select class="form-select" id="search_field" name="search_field" required><option value="">-- Select --</option><option value="guest_name">Guest Name</option><option value="email">Email</option><option value="zone">Zone</option><option value="reason_category">Reason</option><option value="impact_assessment">Impact</option><option value="follow_up_action">Follow-up</option></select></div>
                <div class="col-md-6 mb-3"><label for="search_value" class="form-label">Value</label><input type="text" class="form-control" id="search_value" name="search_value" required></div></div>
