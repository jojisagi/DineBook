<?php
// search_v3.php — No-Shows: Search by GET (link-based)
require_once __DIR__ . '/../auth/guard.php';
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>DineBook — No-Show by Link</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="/dinebook/css/style.css"></head>
<body>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item"><a href="report.php">No-Shows</a></li><li class="breadcrumb-item active">Search by Link</li></ol></nav>
        <h2 class="page-header">Search No-Show by Reason</h2>
        <ul class="list-group">
            <li class="list-group-item"><a href="search_process3.php?reason_category=forgot">Forgot</a></li>
            <li class="list-group-item"><a href="search_process3.php?reason_category=emergency">Emergency</a></li>
            <li class="list-group-item"><a href="search_process3.php?reason_category=weather">Weather</a></li>
            <li class="list-group-item"><a href="search_process3.php?reason_category=no_reason">No Reason</a></li>
            <li class="list-group-item"><a href="search_process3.php?reason_category=other">Other</a></li>
        </ul>
